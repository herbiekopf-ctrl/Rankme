...
export const RANKABLE_CATEGORIES: readonly RankableCategoryDefinition[] = [
  ...
  },
  {
    ...
    description: "College football venues with location, capacity, surface, construction, and setting data.",
    group: "Places",
    icon: "S",
    defaultLength: 10,
  ...
  },
  {
    ...
    singularLabel: "unit",
    description: "Team offense and defense units with available performance context.",
    group: "Programs",
    icon: "U",
    defaultLength: 10,
